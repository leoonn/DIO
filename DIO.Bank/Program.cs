...
namespace DIO.Bank
{
    class Program
    {
        ...
        private static void InserirConta()
        {
            ...
            Console.WriteLine("Digite quanto será depositado inicialmente: ");
            double entradaSaldo = double.Parse(Console.ReadLine());

              Console.WriteLine("Digite o credito que deseja inicialmente: ");
            ...
            Console.WriteLine("Conta cadastrada! Voltando ao menu");
        }
